  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between pb-6 border-b border-white/5 gap-4">
        <div>
          <h1 className="font-display text-4xl font-bold text-white tracking-tight mb-2">Admin Alerts</h1>
          <p className="text-text-muted text-lg">System-wide monitoring and administrative notifications.</p>
        </div>
        {unreadCount > 0 && (
          <button
            onClick={markAllRead}
      ...
      <div className="glass-card border border-white/5 overflow-hidden">
        <div className="p-4 bg-white/[0.02] border-b border-white/5 flex items-center justify-between">
          <div className="flex items-center gap-2 text-[12px] font-bold uppercase tracking-widest text-text-muted">
            ...
            Pending Notifications ({unreadCount})
          </div>
        </div>
          ...
          <AnimatePresence initial={false}>
            {notifications.length === 0 ? (
              ...
              >
                ...
                <p className="text-text-muted text-[14px]">No administrative alerts requiring your attention.</p>
              </motion.div>
            ) : (
                  ...
                  >
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      <div className="flex gap-3 pt-2">
                        <Link 
                          to={`/admin/tickets/${n.ticketId?._id}`}
                          onClick={() => markRead(n._id)}
                        ...
                        >
                          ...
                          Inspect Ticket {n.ticketId?.ticketNumber}
                        </Link>
                      </div>
                    </div>
                  </motion.div>

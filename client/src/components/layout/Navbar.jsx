          ...
          <AnimatePresence>
            {showNotifications && (
              <motion.div
                ...
                className="fixed inset-x-4 top-20 sm:absolute sm:inset-auto sm:top-full sm:right-0 sm:mt-3 w-auto sm:w-96 bg-[#0a0a16] border border-white/10 rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.8)] z-50 overflow-hidden"
              >
